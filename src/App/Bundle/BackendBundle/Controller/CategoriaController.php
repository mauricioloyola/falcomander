...
namespace App\Bundle\BackendBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use App\Bundle\BackendBundle\Entity\Categoria;
use App\Bundle\BackendBundle\Form\CategoriaType;
...
class CategoriaController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $entity->setUsrCreate(1);
            $entity->setUsrUpdate(0);

            $em->persist($entity);
            $em->flush();

            $this->get('session')->getFlashBag()->add('info','Se registro satisfactoriamente');                  
